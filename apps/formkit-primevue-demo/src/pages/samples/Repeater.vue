...
import { useFormKitRepeater, useFormKitSchema } from "formkit-primevue";
...
onMounted(() => {
  const defaultData = {
    name: "Fighter",
    attacks: [
      { name: "Sword", damage: "2D20" },
      { name: "Dagger", damage: "2D6" },
    ],
  };
...
<template>
  <div v-if="data" class="mt-1">
    <PrimeInput header="Repeater" :schema="schema" :data="data" />
  </div>
</template>
