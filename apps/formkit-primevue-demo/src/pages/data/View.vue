...
import { FormKitDataView, useFormKitSchema } from "formkit-primevue";
...
<template>
  <PrimeData header="FormKitDataView Demo">
    ...
    <div class="flex gap-2 mb-4">Horizontal <ToggleSwitch v-model="horizontal" /></div>
    <FormKitDataView
      id="FormKitDataViewId"
      v-model="data"
      :schema="outputSchema"
      debug-data
      debug-schema
