...
var d = (0, vue_i18n_1.useI18n)().d;
var converted = (0, vue_1.computed)(function () {
    var _a, _b, _c, _d, _e, _f;
    if ((_a = props === null || props === void 0 ? void 0 : props.context) === null || _a === void 0 ? void 0 : _a._value) {
        var result = "";
        var format = ((_d = (_c = (_b = props === null || props === void 0 ? void 0 : props.context) === null || _b === void 0 ? void 0 : _b.attrs) === null || _c === void 0 ? void 0 : _c.value) === null || _d === void 0 ? void 0 : _d.format)
            ? (_e = props === null || props === void 0 ? void 0 : props.context) === null || _e === void 0 ? void 0 : _e.attrs.value.format
            : "short";
        try {
            result = d((_f = props === null || props === void 0 ? void 0 : props.context) === null || _f === void 0 ? void 0 : _f._value, format);
        }
        catch (e) {
...
__VLS_asFunctionalElement1(__VLS_intrinsics.div, __VLS_intrinsics.div)(__assign({ class: "p-formkit p-output-date" }));
/** @type {__VLS_StyleScopedClasses['p-formkit']} */ ;
/** @type {__VLS_StyleScopedClasses['p-output-date']} */ ;
...
// @ts-ignore
[hasPrefixIcon, context, context, context, context, context, context, context, context, context, hasPrefix, converted, hasSuffix, hasSuffixIcon,];
