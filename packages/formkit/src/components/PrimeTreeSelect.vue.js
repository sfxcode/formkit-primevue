...
for (var _i = 0, _4 = __VLS_vFor((__VLS_ctx.validSlotNames)); _i < _4.length; _i++) {
    var slotName = _4[_i][0];
    {
        ...
        // @ts-ignore
        [modelValue, context, context, context, context, context, context, context, context, context, context, context, context, context, context, context, context, context, context, context, context, context, context, context, context, isInvalid, unstyled, handleInput, handleBlur, validSlotNames,];
    }
    // @ts-ignore
    [];
}
