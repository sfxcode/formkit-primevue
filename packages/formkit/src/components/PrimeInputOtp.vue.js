...
var _1 = (0, index_ts_1.useFormKitInput)(props.context), validSlotNames = _1.validSlotNames, unstyled = _1.unstyled, isInvalid = _1.isInvalid, handleBlur = _1.handleBlur, handleInput = _1.handleInput, modelValue = _1.modelValue;
...
for (var _i = 0, _2 = __VLS_vFor((__VLS_ctx.validSlotNames)); _i < _2.length; _i++) {
    var slotName = _2[_i][0];
    {
        var _3 = __VLS_3.slots, _4 = __VLS_tryAsConstant(slotName), __VLS_9 = _3[_4];
        var slotProps = __VLS_vSlot(__VLS_9)[0];
        var __VLS_10 = ((_0 = __VLS_ctx.context) === null || _0 === void 0 ? void 0 : _0.slots[slotName]);
        // @ts-ignore
        ...
        // @ts-ignore
        [context, context, context, context, context, context, context, context, context, context, context, context, context, context, context, context, context, context, modelValue, isInvalid, unstyled, handleInput, handleBlur, validSlotNames,];
    }
    // @ts-ignore
    [];
}
