...
var _3 = (0, index_ts_1.useFormKitInput)(props.context), validSlotNames = _3.validSlotNames, unstyled = _3.unstyled, isInvalid = _3.isInvalid, handleChange = _3.handleChange, handleBlur = _3.handleBlur, modelValue = _3.modelValue;
...
for (var _i = 0, _4 = __VLS_vFor((__VLS_ctx.validSlotNames)); _i < _4.length; _i++) {
    var slotName = _4[_i][0];
    {
        ...
        // @ts-ignore
        [context, context, context, context, context, context, context, context, context, context, context, context, context, context, context, context, context, context, context, context, modelValue, isInvalid, unstyled, handleChange, handleBlur, validSlotNames,];
    }
    // @ts-ignore
    [];
}
