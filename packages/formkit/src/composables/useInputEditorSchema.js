...
function useInputEditorSchema() {
    var _a = (0, useFormKitSchema_ts_1.useFormKitSchema)(), addList = _a.addList, addListGroup = _a.addListGroup;
    var _b = (0, useFormKitRepeater_ts_1.useFormKitRepeater)(), addInsertButton = _b.addInsertButton, addGroupButtons = _b.addGroupButtons;
    var _c = (0, useInputEditor_ts_1.useInputEditor)(), primeInputNames = _c.primeInputNames, primeOutputNames = _c.primeOutputNames;
    function primeInputOptions(list) {
        return list.map(function (name) {
            return { label: name, value: "prime".concat(name) };
        });
    }
    var selectOptions = [
    ...
    function editorSchema(inputOptions) {
        if (inputOptions === void 0) { inputOptions = primeInputOptions(__spreadArray(__spreadArray([], primeInputNames, true), primeOutputNames, true)); }
        return [
            {
                $formkit: "primeSelect",
                id: "inputSelection",
    ...
    return { editorSchema: editorSchema, primeInputOptions: primeInputOptions };
}
