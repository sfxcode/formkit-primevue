import{_ as i,D as e,c as l,I as t,j as s,a,a4 as p,o as h}from"./chunks/framework.BuqSIulK.js";const f=JSON.parse('{"title":"Options","description":"","frontmatter":{},"headers":[],"relativePath":"guide/options.md","filePath":"guide/options.md"}'),o={name:"guide/options.md"},r=s("h1",{id:"options",tabindex:"-1"},[a("Options "),s("a",{class:"header-anchor",href:"#options","aria-label":'Permalink to "Options"'},"​")],-1),E=s("p",null,"In some inputs options are needed. There are several ways to deal with the options.",-1),k=s("h2",{id:"option-based-inputs",tabindex:"-1"},[a("Option based Inputs "),s("a",{class:"header-anchor",href:"#option-based-inputs","aria-label":'Permalink to "Option based Inputs"'},"​")],-1),c=p(`<h2 id="ways-of-usage" tabindex="-1">Ways of Usage <a class="header-anchor" href="#ways-of-usage" aria-label="Permalink to &quot;Ways of Usage&quot;">​</a></h2><h3 id="simple-array" tabindex="-1">Simple Array <a class="header-anchor" href="#simple-array" aria-label="Permalink to &quot;Simple Array&quot;">​</a></h3><div class="language-vue vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">vue</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">const stringArray = [&#39;refresh&#39;, &#39;hourly&#39;, &#39;daily&#39;]</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    },</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">]</span></span></code></pre></div>`,9);function d(y,g,b,u,m,v){const n=e("DisplayComponents");return h(),l("div",null,[r,E,k,t(n,{full:!1}),c])}const j=i(o,[["render",d]]);export{f as __pageData,j as default};
