import{_ as e,c as l,j as a,a as n,G as p,ag as t,B as o,o as h}from"./chunks/framework.CKtt-CHA.js";const u=JSON.parse('{"title":"Options","description":"","frontmatter":{},"headers":[],"relativePath":"guide/options.md","filePath":"guide/options.md"}'),r={name:"guide/options.md"};function E(k,s,c,d,y,g){const i=o("DisplayComponents");return h(),l("div",null,[s[0]||(s[0]=a("h1",{id:"options",tabindex:"-1"},[n("Options "),a("a",{class:"header-anchor",href:"#options","aria-label":'Permalink to "Options"'},"​")],-1)),s[1]||(s[1]=a("p",null,"In some inputs options are needed. There are several ways to deal with the options.",-1)),s[2]||(s[2]=a("h2",{id:"option-based-inputs",tabindex:"-1"},[n("Option based Inputs "),a("a",{class:"header-anchor",href:"#option-based-inputs","aria-label":'Permalink to "Option based Inputs"'},"​")],-1)),p(i,{full:!1}),s[3]||(s[3]=t(`<h2 id="ways-of-usage" tabindex="-1">Ways of Usage <a class="header-anchor" href="#ways-of-usage" aria-label="Permalink to &quot;Ways of Usage&quot;">​</a></h2><h3 id="simple-array" tabindex="-1">Simple Array <a class="header-anchor" href="#simple-array" aria-label="Permalink to &quot;Simple Array&quot;">​</a></h3><div class="language-vue vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">vue</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">const stringArray = [&#39;refresh&#39;, &#39;hourly&#39;, &#39;daily&#39;]</span></span>
